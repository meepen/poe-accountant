...
interface CurrencyValueDisplayProps {
  ...
  sharedCurrencyListOverride?: unknown;
...
export default function CurrencyValueDisplay({
  ...
  const normalizedSharedCurrencyList = useMemo(
    () =>
      normalizeSharedCurrencyList(
        sharedCurrencyListOverride ?? (sharedCurrencyList as unknown),
      ),
    [sharedCurrencyList, sharedCurrencyListOverride],
  );
